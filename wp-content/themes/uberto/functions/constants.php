...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'uberto');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Uberto');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://www.cssigniter.com/support/viewforum.php?f=73');
