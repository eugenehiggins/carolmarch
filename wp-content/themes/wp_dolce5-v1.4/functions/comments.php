...
function ci_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		<div id="comment-<?php comment_ID(); ?>" class="comment-text clearfix">
			<?php echo get_avatar( $comment, 50 ); ?>
			<div class="comment-copy">
				<p class="comment-meta post-meta">
					<?php echo get_comment_author_link() . " <span class=\"meta-bullet\"></span> " . get_comment_date() . ' ' . get_comment_time(); ?>
				</p>
				<?php comment_text(); ?>
