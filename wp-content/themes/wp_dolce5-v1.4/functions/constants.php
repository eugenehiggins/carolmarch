...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'dolce');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Dolce'); 
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.com/support/viewforum.php?f=41');
