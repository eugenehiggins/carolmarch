...
function ci_register_theme_styles()
{
	...
	wp_register_style('google-font-prata', 'http://fonts.googleapis.com/css?family=Prata');
	wp_register_style('skeleton', get_child_or_parent_file_uri('/stylesheets/skeleton.css'));

	wp_register_style('ci-style', get_stylesheet_uri(), array('skeleton'), CI_THEME_VERSION, 'screen');
...
function ci_enqueue_theme_styles()
{
	...
	wp_enqueue_style('google-font-prata');	
